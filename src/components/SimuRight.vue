    ...
    <div class="row">
      <div class="col simu_result_box">
        ...
        <div class="simulator__image_view border">
          <div class="sample">
            <img :src="main_model_path.model_path" class="img_torso" />
            <object
            ...
            ></object>
            <img :src="main_model_path.shadow_path" class="img_shadow" />
          </div>
          <div class="options">
            <img
          ...
          <div class="fullScreenBtn full_modal_show" @click="modalFullviewShow">
      ...
      <div class="simu-modal-fullview">
        ...
        >
          <div class="simulator__image_view">
            ...
            <div
              class="fullScreenBtn fullScreenBtn02 full_modal_hide"
  ...
  computed: {
    ...
    option_main_path: function() {
      ...
      if (this.viewMode != "") {
        ...
        if (this.partNo != "") {
          option_main_src =
            this.server_img_path + "simulator/options/" + this.partNo + "/";
        } else {
          option_main_src = this.server_img_path + "simulator/options/" + "3/";
        }
      }
